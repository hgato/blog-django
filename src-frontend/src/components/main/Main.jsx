        ...
        return (
            <div className="Main">
                ...
                <Route exact path="/login"
                       render={(props) => <Login {...props} user={this.props.user} setUser={this.props.setUser}/>}/>
                <Route exact path="/posts/:id(\d+)" render={(props) => <Post {...props} user={this.props.user}/>}/>
                <Route exact path="/posts/:id(\d+)/edit"
                       render={(props) => <EditPost {...props} user={this.props.user}/>}/>
